...
// fn main() {
//     println!("{}", exam_done_independently());
//     println!("{}", multiple_choice_closed_book());
//     println!("{}", multiple_choice_no_run());
//     println!("{}", coding_no_copy());
//     println!("{}", coding_no_external_deps());
//     println!("{}", coding_no_ai_helpers());
// }
